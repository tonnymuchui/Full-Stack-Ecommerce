  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gas-x-8 gap-y-10 px-4 pt-10">
          {/* Image gallery */}
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">564 Ratings</p>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">564 Ratings</p>
                </div>
...
{/* Smiler Products */}
        <section className="pt-10">
          <h1 className="py-5 text-lg font-bold">Similar Products</h1>
